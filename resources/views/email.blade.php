			...
			<div class="contact-form">
                ...
                @csrf
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label for="inputEmail">Email de destination</label>
								<input type="email" name="email" class="form-control" placeholder="entrer un email">
                                @error('email')
                                <span class="text-danger"> {{ $message }} </span>
                                @enderror
							</div>
					...
					<div class="form-group">
                        ...
                        <textarea name="content" rows="5" class="form-control" placeholder="entrer un message"></textarea>
                        @error('content')
                        <span class="text-danger"> {{ $message }} </span>
                        @enderror
					</div>
